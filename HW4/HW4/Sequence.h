...
template <typename ItemType>
inline Sequence<ItemType>::Sequence()
{
    createEmpty();
}
...
template <typename ItemType>
inline Sequence<ItemType>::Sequence(const Sequence<ItemType>& other)
{
    createEmpty();
...
template <typename ItemType>
inline Sequence<ItemType>& Sequence<ItemType>::operator=(const Sequence<ItemType>& rhs)
{
    if (this != &rhs)
    {
        Sequence temp(rhs);
...
template <typename ItemType>
inline bool Sequence<ItemType>::insert(int pos, const ItemType& value)
{
    if (pos < 0  ||  pos > m_size)
        return false;
...
template <typename ItemType>
inline int Sequence<ItemType>::insert(const ItemType& value)
{
...
template <typename ItemType>
inline bool Sequence<ItemType>::erase(int pos)
{
    if (pos < 0  ||  pos >= m_size)
        return false;
...
template <typename ItemType>
inline int Sequence<ItemType>::remove(const ItemType& value)
{
    int count = 0;
...
template <typename ItemType>
inline bool Sequence<ItemType>::get(int pos, ItemType& value) const
{
    if (pos < 0  ||  pos >= m_size)
        return false;
...
template <typename ItemType>
inline bool Sequence<ItemType>::set(int pos, const ItemType& value)
{
    if (pos < 0  ||  pos >= m_size)
        return false;
...
template <typename ItemType>
inline int Sequence<ItemType>::find(const ItemType& value) const
{
...
template <typename ItemType>
inline void Sequence<ItemType>::swap(Sequence& other)
{
    // Swap head pointers
...
template <typename ItemType>
inline void Sequence<ItemType>::createEmpty()
{
    m_size = 0;
...
template <typename ItemType>
inline void Sequence<ItemType>::insertBefore(Node* p, const ItemType& value)
{
    // Create a new node
...
template <typename ItemType>
inline typename Sequence<ItemType>::Node* Sequence<ItemType>::doErase(Node* p)
{
...
template <typename ItemType>
inline typename Sequence<ItemType>::Node* Sequence<ItemType>::nodeAtPos(int pos) const
{
    Node* p;
