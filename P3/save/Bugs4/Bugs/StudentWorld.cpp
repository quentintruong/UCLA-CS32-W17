...
StudentWorld::~StudentWorld(){
    cleanUp();
    if (m_compilerForEntrant0 != nullptr)
        delete m_compilerForEntrant0;
    if (m_compilerForEntrant1 != nullptr)
        delete m_compilerForEntrant1;
    if (m_compilerForEntrant2 != nullptr)
        delete m_compilerForEntrant2;
    if (m_compilerForEntrant3 != nullptr)
        delete m_compilerForEntrant3;
}
